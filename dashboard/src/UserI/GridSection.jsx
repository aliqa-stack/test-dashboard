...
const GridSection = () => {
  return (
    <div className='flex justify-center p-4'>
      <section className="grid w-full max-w-5xl grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-6 lg:grid-rows-4">
        <div className="sm:col-span-2 lg:col-span-2 lg:row-span-4">
          <div className='h-full min-h-68 w-full rounded-2xl bg-linear-to-br from-cyan-500 to-blue-400 shadow-lg transition duration-500 ease-in-out hover:from-blue-600 hover:shadow-xl hover:shadow-slate-500'>
            ...
            <div className="sm:col-span-2 lg:col-span-4 lg:row-span-2 lg:col-start-3">
            ...
            <div className="lg:col-span-2 lg:row-span-2 lg:col-start-3 lg:row-start-3">
              <div className='bg-linear-to-br from-violet-500 to-fuchsia-400 rounded-2xl lg:h-32 h-full shadow-lg hover:shadow-xl hover:shadow-slate-500 duration-400 transition ease-in-out '>
              <div className='p-4'>
            ...
            <div className="lg:col-span-2 lg:row-span-2 lg:col-start-5 lg:row-start-3">
              <div className='bg-linear-to-br from-orange-500 to-amber-400 rounded-2xl h-32 shadow-lg hover:shadow-xl hover:shadow-slate-500 duration-400 transition ease-in-out'>
              <div className='p-4 '>
                <span className='font-semibold text-xl font-inter'>Lorem ipsum dolor sit amet.</span>
              </div>
              </div>
