    ...
    <div className='flex justify-between justify-center p-4'>
        <section className="grid lg:grid-cols-6 lg:grid-rows-4 gap-2">
            <div className="lg:col-span-2 lg:row-span-4">
              <div className='shadow-lg hover:shadow-xl hover:shadow-slate-500 bg-linear-to-br from-cyan-500  to-blue-400 hover:from-blue-600 duration-500 transition ease-in-out   rounded-2xl h-68 w-72'>
                <div className='p-4 '>
            ...
            <div className="lg:col-span-2 lg:row-span-2 lg:col-start-3 lg:row-start-3">
              <div className='bg-linear-to-br from-violet-500 to-fuchsia-400 rounded-2xl h-32 shadow-lg hover:shadow-xl hover:shadow-slate-500 duration-400 transition ease-in-out '>
              <div className='p-4'>
            ...
            <div className="lg:col-span-2 lg:row-span-2 lg:col-start-5 lg:row-start-3">
              <div className=' bg-linear-to-br from-orange-500 to-amber-400 rounded-2xl h-32 shadow-lg shadow-lg hover:shadow-xl hover:shadow-slate-500 duration-400 transition ease-in-out  '>
              <div className='p-4 '>
                <span className='font-semibold text-xl font-inter'>Lorem ipsum dolor sit amet.</span>
              </div>
              </div>
